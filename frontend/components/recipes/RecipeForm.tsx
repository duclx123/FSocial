...
export default function RecipeForm({ initialData, onSave, onCancel }: RecipeFormProps) {
  ...
  const [instructions, setInstructions] = useState<Instruction[]>(
    initialData?.recipe_instructions || [{ step_number: 1, description: '', duration_minutes: undefined }]
  );
  ...
  const addInstruction = () => {
    setInstructions([
      ...instructions,
      { step_number: instructions.length + 1, description: '', duration_minutes: undefined }
    ]);
  };
